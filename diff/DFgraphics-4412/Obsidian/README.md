...
https://github.com/DFgraphics/Obsidian/releases
 ...
 * Copy the "onLoad\_gfx\_Obsidian.init" file into the /raw/ folder.
...
3.0 - Credits:
________________________________________
- Obsidian Soul (he probably drew a lot of the main tilesheet)
- Sphr (creatures)
- NW_Kohaku (creatures)
- Jiri Petru (creatures)
- Kafine (creatures)
- Bane (creatures)
- Magnut (creatures)
- Deon (creatures)
- Ironhand (rock tiles)
- Darkond & Hermano (furniture and finished goods)
- Meph & Deon (animated grass idea)
- Meph (TWBT weapon/armor/etc items)
- Neale Davidson (Dalelands font)
- Phoebus text symbols
- Tarn (for DF)
