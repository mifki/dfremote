local labor_groups = { --as:{1:string,2:number,3:{_array:{1:string,2:number,3:number,4:number,5:bool}}}[]
    ...
    { "Crafts", 9, {
        ...
        { "Papermaker", df.profession.PAPERMAKER, df.unit_labor.PAPERMAKING, df.job_skill.PAPERMAKING },
        { "Bookbinder", df.profession.BOOKBINDER, df.unit_labor.BOOKBINDING, df.job_skill.BOOKBINDING }
    } },
    { "Engineering", 12, {
